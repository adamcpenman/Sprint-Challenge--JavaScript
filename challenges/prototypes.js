...
/* == Step 3: Surface Area Method ==
  Create another method using CuboidMaker's prototype that returns 
  the surface area of a given cuboid's length, width, and height. 
...
console.log("surfaceArea of the cuboid", cuboid.surfaceArea()); // 130
